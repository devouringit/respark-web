...
import { UPDATE_GROUP_STATUS, UPDATE_LOADER_STATUS, UPDATE_CURRENT_PAGE, UPDATE_PDP_ITEM, UPDATE_PDP_ITEM_STATUS, UPDATE_SEARCH_STATUS, UPDATE_ERROR_STATUS, UPDATE_GENERIC_IMAGES, UPDATE_WHATSAPP_TEMPLATES } from '@constant/common';
