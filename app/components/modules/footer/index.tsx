                        ...
                        <div className="social-icon-wrap">
                            {socialLinks.length !== 0 && socialLinks.map((linkData, index) => {
                                return <div className="social-icon glass-card" key={Math.random()} onClick={() => onClickType(linkData.name, linkData)}>
                                    {linkData.name.includes('instagram') && <img className="insta" src="/assets/Icons/social/insta.svg" />}
                    ...
                    <div className="information-wrap">
                        ...
                        {storesList && configData.showStoreLocator && storesList.length > 1 ?
                            ...
                            <span className="containt" style={{ textTransform: 'capitalize' }}>
                                <a href={`${storeMetaData.googleMapUrl ? storeMetaData.googleMapUrl : `https://www.google.com/maps/search/?api=1&query=${storeMetaData.latitude},${storeMetaData.longitude}`}`} rel="noreferrer" target="_blank">
