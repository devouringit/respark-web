    ...
    useEffect(() => {
        if (router.query.pagepath.includes("orderconfirmation")) {
            if (router.query.status == 'paid') {
                ...
                router.push({ pathname: baseRouteUrl + 'cart' }, '', { shallow: true });
            }
        }
    }, [router])
            ...
            {orderSuccess ?
                <div className="con-main-wrap clearfix">
                    ...
                    <div className="order-details-wrap">
                        ...
                        <div className="cart-button-wrap">
                            <button className="cart-button" onClick={() => router.push({ pathname: baseRouteUrl + 'home' }, '', { shallow: true })}>Explore More</button>
                        </div>
                    </div>
                </div>
                :
                <div className="con-main-wrap">
                    <div className="con-wrap">
                        ...
                        <div><button className="cart-button" onClick={() => router.push({ pathname: baseRouteUrl + 'home' }, '', { shallow: true })}>Explore More</button></div>
                    </div>
                </div>}
        </>
    )
