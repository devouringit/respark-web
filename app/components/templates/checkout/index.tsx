...
import { disableLoader, enableLoader, showError, updatePdpItem, updateStore, updateWhatsappTemplates } from 'app/redux/actions';
...
function GrFormLocation(props) {
    return <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 20 20" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clip-rule="evenodd"></path></svg>;
}
...
function CheckoutPage() {
        ...
        return new Promise((res, rej) => {
            if (type.optInForWapp) res(true)
                ...
                markUserOptIn(gupshupConfig, type.number).then(() => {
                    //update in db
                    if (type.from == 'user') {
                        markUserOptInForWhatsapp(storeMetaData.tenantId, [type.number]).then(() => {
    ...
    return (
        <div className="cart-page-wrap main-wrapper checkout-page-wrap">
            {!showOrderConfirmation ?
                ...
                <div className="emptyCart-main-wrap">
                    ...
                    <div className="order-details-wrap glass-card">
                        ...
                        <div className="confirm-btn-wrap book-wrap alignment">
                            <button className="primary-btn" onClick={() => router.push({ pathname: baseRouteUrl + 'home' }, '', { shallow: true })}>Explore More</button>
                        </div>
                    </div>
                </div>
            }
