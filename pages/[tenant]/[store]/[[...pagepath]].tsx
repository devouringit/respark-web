  ...
  useEffect(() => {
    ...
    if (storeData && storeData.storeId) {
      ...
      if (router.query.pagepath) {
        ...
        if (router.query.pagepath?.length) current_page_url = (router.query.pagepath.includes('feedback') || router.query.pagepath.includes('invoice')) ? router.query.pagepath[0] : router.query.pagepath[router.query.pagepath.length - 1];//if appointmentid present then page is feedback
        ...
        currentPage == 'checkout' ? <CheckoutPage />
          ...
          currentPage == 'feedback' ? <FeedbackPage storeData={storeData} metaTags={metaTags} />
            ...
            currentPage == 'appointment' ?
              ...
              currentPage == 'invoice' ? <InvoicePage storeData={storeData} metaTags={metaTags} />
                : null
    }
  </>
}
